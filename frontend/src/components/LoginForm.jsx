...
const LoginForm = ({ redirectUrl }) => {
  ...
  return (
    <>
      <form className='m-auto my-16 max-w-[500px] bg-gray-700 p-8 border-2 border-gray-600  shadow-md rounded-md text-white flex flex-col justify-center items-center'>
        {loading ? (
          <Loader />
        ) : (
          <>
            <h2 className='text-center mb-4 text-2xl font-bold'>Login here</h2>
            ...
            <div className='pt-4 flex gap-2'>
              ...
              <Link to="/signup" className='text-red-400'>Signup here</Link>
            </div>
          </>
        )}
      </form>
