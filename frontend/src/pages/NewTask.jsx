...
const Task = () => {
  ...
  return (
    <>
      <MainLayout>
        <form className='sm:m-auto m-4 my-16 max-w-[1000px] bg-gray-700 text-white p-8 border-2 border-gray-600 shadow-md rounded-md'>
          {loading ? (
            <Loader />
          ) : (
            <>
              <h2 className='text-center mb-4 text-3xl font-bold'>{mode === "add" ? "Add New Task" : "Edit Task"}</h2>
              <div className="mb-4">
                <label htmlFor="description">Description</label>
                <Textarea type="description" name="description" id="description" value={formData.description} placeholder="Write here.." onChange={handleChange} className='bg-gray-800 border-gray-600 ' />
